...
@section('content')
  ...
  <div class="card">
    ...
    <div class="row">
      <div class="col">
  <img src="/storage/profile_images/{{$user->profile_img}}" alt="profile_img" class='profile-img'>
...
<tr>
  <td class="">Name:</td>
  <td class="col">  {{Form::text('name', $user->name,['class' => 'form-control', 'placeholder' => 'Title'])}}</td>
</tr>
<tr>
  <td class="">Birthday:</td>
  <td class="col">@if(!$user->birthday) Unspecified @endif{{$user->birthday}}
...
<tr>
  <td class="">Gender:</td>
  <td class="col">@if(!$user->sex) Unspecified @endif
    <div class="col-md-6">
...
<tr>
  <td class="">Country:</td>
  <td class="col">@if(!$user->country) Unspecified @endif
      <div class="col-md-6">
